...
const navItems = [
  ...
  { icon: Layers,          key: "fields",     defaultLabel: "Talhões",      href: "fields" },
  { icon: Sprout,          key: "seasons",    defaultLabel: "Safra",        href: "seasons" },
  { icon: Truck,           key: "fleet",      defaultLabel: "Frota",        href: "fleet" },
  ...
  return (
    ...
    >
      ...
      <div className={cn("flex h-14 items-center border-b border-border px-3", collapsed ? "justify-center" : "gap-2")}>
        <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded bg-primary text-primary-foreground text-xs font-bold font-heading">
          A
        </div>
        {!collapsed && (
          <span className="text-sm font-semibold tracking-tight text-foreground font-heading">AURELIUS</span>
        )}
      </div>
